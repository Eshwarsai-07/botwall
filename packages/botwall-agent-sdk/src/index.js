/**
 * botwall-agent-sdk — turnkey 402 paywall client for AI agents.
 *
 * Quick start:
 *
 ...
 *
 *   console.log("paid:", res.botwallPayment?.signature);
 *   console.log("spend:", client.spend());
 */

export { createAgentBotwallClient } from "./core/client.js";
