      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-20">
        ...
        <section id="publisher" className="mt-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-xs text-inkSubtle font-mono">botwall-sdk</div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <InstallBlock cmd="npm install botwall-sdk" />
            </div>

            <div>
              <div className="text-xs text-inkSubtle mb-2 font-medium">Express</div>
              <InstallBlock cmd='import { createPaywall } from "botwall-sdk"; import { expressMiddleware } from "botwall-sdk/express";' />
            </div>
            <div>
              <div className="text-xs text-inkSubtle mb-2 font-medium">Next.js</div>
              <InstallBlock cmd='import { paywallMiddleware } from "botwall-sdk/nextjs";' />
            </div>
            <div>
              <div className="text-xs text-inkSubtle mb-2 font-medium">Fastify</div>
              <InstallBlock cmd='import { fastifyPlugin } from "botwall-sdk/fastify";' />
            </div>
            <div>
              <div className="text-xs text-inkSubtle mb-2 font-medium">Cloudflare Workers</div>
              <InstallBlock cmd='import { cloudflareHandler } from "botwall-sdk/cloudflare";' />
            </div>
          </div>
...
app.use(expressMiddleware(paywall));`}</pre>
        ...
        <section id="agent">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="text-xs text-inkSubtle font-mono">botwall-agent-sdk</div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <InstallBlock cmd="npm install botwall-agent-sdk @solana/web3.js @solana/spl-token @x402-solana/core" />
            </div>
            <div>
              <div className="text-xs text-inkSubtle mb-2 font-medium">LangChain tool</div>
              <InstallBlock cmd='import { paywallFetchTool } from "botwall-agent-sdk/langchain";' />
            </div>
          </div>

          <div className="mt-6 p-4 rounded-xl border border-border bg-surface">
            <div className="text-xs text-inkSubtle mb-2 font-medium">Minimum config</div>
            <pre className="code-block text-inkMuted text-xs">{`import { createAgentPaywallClient, fromKeypairFile } from "botwall-agent-sdk";
