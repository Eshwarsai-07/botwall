...
export const GET = withRouteHandler(paywall, async (req) =>
  ...
  "agent-install": {
    lang: "bash",
    code: `npm install botwall-agent-sdk \\
  @solana/web3.js \\
  @solana/spl-token \\
  @x402-solana/core
...
try {
  ...
  "agent-langchain": {
    lang: "js",
    code: `import { createAgentPaywallClient, fromKeypairFile } from "botwall-agent-sdk";
        ...
        >
          ...
          <div className="border-t border-border px-4 py-2 flex items-center gap-2">
            ...
            <span className="text-xs text-inkSubtle">
              {active.startsWith("publisher") ? "botwall-sdk" : "botwall-agent-sdk"} — MIT license
            </span>
          </div>
        </motion.div>
      </div>
