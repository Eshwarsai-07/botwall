...
const REASONS = [
  ...
  },
  {
    ...
    a: "Nothing. But on-chain verification means Botwall's server doesn't need to trust the agent — or be trusted by the agent. The Solana RPC is the neutral arbiter. No payment processor account to ban you.",
  },
];
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr className="bg-raised">
                  <td className="px-4 py-3 text-ink font-medium">Solana USDC ← Botwall</td>
