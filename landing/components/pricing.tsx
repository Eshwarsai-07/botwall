      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-inkMuted max-w-xl mx-auto">
            Botwall never takes a cut of on-chain payments. The plan fee covers
        ...
        <p className="mt-8 text-center text-xs text-inkSubtle">
          All plans include both SDKs under MIT license. No transaction fee from Botwall — only Solana network fees (~$0.00025/tx).
        </p>
      </div>
    </section>
  );
