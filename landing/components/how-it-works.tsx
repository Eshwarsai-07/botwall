...
const STEPS = [
  {
    ...
    body: "An AI crawler requests your page. Botwall's SDK detects it via user-agent, header fingerprinting, and datacenter IP scoring — before serving a single byte.",
...
function FlowDiagram() {
  return (
    <svg viewBox="0 0 800 120" className="w-full" aria-label="Payment flow diagram">
      ...
      <text x="70" y="72" textAnchor="middle" fill="#525252" fontSize="10" fontFamily="monospace">botwall-agent-sdk</text>
      ...
      <text x="290" y="72" textAnchor="middle" fill="#525252" fontSize="10" fontFamily="monospace">botwall-sdk</text>
